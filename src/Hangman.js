  ...
  render() {
    ...
    return (
      <div className="Hangman">
        <h1><img src={logo} alt={'Portinari!!'} style={{ height: '75px', width: '75px' }} /></h1><h1> Jogo da Forca </h1>
        ...
        <p className="Hangman-word">
          {!gameOver ? `Dica: ${this.props.character.from}` : ''}
        </p>
        <p className="Hangman-btns">{gameState}</p>
        <p className="Hangman-word">
          {(gameState === "Você Venceu!!!" || gameState === "Não foi dessa vez... :(") &&
            <img src={this.props.character.image} alt={this.props.character.name} style={{ height: '100px' }} />}
        </p>
